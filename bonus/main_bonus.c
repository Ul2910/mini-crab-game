...
void	create_imgs(t_map *map)
{
	...
	map->img.crab2 = mlx_new_image(map->mlx, 50, 50);
	map->img.seaweed1 = mlx_new_image(map->mlx, 50, 50);
	map->img.seaweed2 = mlx_new_image(map->mlx, 50, 50);
	...
	map->img.crab2 = mlx_xpm_file_to_image(map->mlx, "img/crab2.xpm",
			&img_width, &img_height);
	map->img.seaweed1 = mlx_xpm_file_to_image(map->mlx, "img/seaweed1.xpm",
			&img_width, &img_height);
	map->img.seaweed2 = mlx_xpm_file_to_image(map->mlx, "img/seaweed2.xpm",
			&img_width, &img_height);
...
void	print_frame(t_map *map)
{
	...
	mlx_put_image_to_window(map->mlx, map->mlx_win, map->digits.zero, 0, 0);
}
